		 ...
		 toLocal:(NSString*)localPath
{
	...
	NSLog(@"will download: '%@' to: '%@'", remotePath, localPath);
...
- (void)connection:(NSURLConnection *)conn didReceiveResponse:(NSURLResponse *)response
{
	...
	NSLog(@"total number of bytes: %qi", totalFileBytes);
...
- (void)connection:(NSURLConnection *)conn didFailWithError:(NSError *)error
{
	...
	NSLog(@"download failed with error: %@ / %@", [error localizedDescription], [error localizedFailureReason]);
