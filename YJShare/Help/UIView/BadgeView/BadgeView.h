...
typedef enum {
    BadgeViewHorizontalAlignmentNone,
    BadgeViewHorizontalAlignmentLeft,
    BadgeViewHorizontalAlignmentCenter,
    BadgeViewHorizontalAlignmentRight
} BadgeViewHorizontalAlignment;

typedef enum {
    BadgeViewVerticalAlignmentNone,
    BadgeViewVerticalAlignmentTop,
    BadgeViewVerticalAlignmentMiddle,
    BadgeViewVerticalAlignmentBottom
} BadgeViewVerticalAlignment;
 ...
 */
@property (nonatomic, assign) BadgeViewHorizontalAlignment horizontalAlignment;
/*
 ...
 */
@property (nonatomic, assign) BadgeViewVerticalAlignment verticalAlignment;
/*
